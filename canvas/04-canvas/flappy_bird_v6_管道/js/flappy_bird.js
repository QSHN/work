...
FlappyBird.prototype = {
    ...
    * */
    initRoles: function(imgs) {
        ...
        for(i = 0; i < tempTotle; i++) {
            this.roles.pipe.push(new Pipe({
                ...
                LRSpace: 120,
                TBSpace: 120,
                pipeViewHeight: this.ctx.canvas.height - imgs.land.height
            }));
        }
    ...
    // 判断小鸟是否死亡
    isDie: function() {
        var birdCoreX = this.roles.bird[0].x + this.roles.bird[0].width / 2;
        var birdCoreY = this.roles.bird[0].y + this.roles.bird[0].height / 2;
