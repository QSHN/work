...
<script>
import { getStaff, addStaffs } from '@/api/nursing/statistics/statistics'
import { tableOption } from '@/const/crud/nursing/statistics/nures'
...
export default {
  ...
  methods: {
    getList(page, params) {
      ...
      getStaff(this.officeId).then(response => {
        // 处理imgUrl
