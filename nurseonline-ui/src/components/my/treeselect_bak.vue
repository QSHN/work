  ...
  export default {
    ...
    methods: {
      ...
      initHandle() {
        ...
        this.$nextTick(() => {
          let scrollWrap = document.querySelectorAll('.tree-select .el-scrollbar .el-select-dropdown__wrap')[0]
          let scrollBar = document.querySelectorAll('.tree-select .el-scrollbar .el-scrollbar__bar')
      ...
      handleNodeClick(node) {
        ...
        this.$emit('node-select', this.valueId)
