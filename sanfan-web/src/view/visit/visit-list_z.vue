  ...
  <Card style="width: 100%; height: 100%; overflow: auto">
    <Tabs v-model="tab">
      <TabPane label="我的拜访" name="executor">
        <visit-table :tab="'executor'" @show="show" ref="executor" @look="look" :clientVisitingType="'INTERVIEW'" />
      </TabPane>

      <TabPane label="我的派发" name="creator" v-if="getUserInfo.role === 'SUPERADMIN' || getUserInfo.role === 'DEPARTMENTADMIN'">
        <visit-table :tab="'creator'" @show="show" ref="creator"  @look="look" :clientVisitingType="'INTERVIEW'" />
      </TabPane>
    </Tabs>
    <visit-create-modal ref="visitCreateModal" @update="load" :clientVisitingType="'INTERVIEW'" />
