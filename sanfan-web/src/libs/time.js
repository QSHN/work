...
export const getMonthFilter = (index, qDate) => {
  let now = new Date() || qDate
...
export const getDateFilter = (index, date) => {
...
export const getWeekStatus = (date, workDays) => {
...
export const toDate = (time) => {
  let hms = time.split(':')
  let hh = parseInt(hms[0])
  let mm = parseInt(hms[1])
  let ss = parseInt(hms[2] ? hms[2] : '0')
  let d = new Date()
  d.setHours(hh)
  d.setMinutes(mm)
  d.setSeconds(ss)
