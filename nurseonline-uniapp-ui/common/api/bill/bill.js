...
export function submitBill(obj) {
	...
	obj.billInfo = Object.assign({},obj.billInfo,{
		vipId: vipInfo.vipId,
		vipName: vipInfo.vipName
	})
	
	return http.request({
		url: '/nursing-admin/bill/submit',
		method: 'POST',
		data: obj
	})
}
...
//获取服务工单列表
export function getBillList(obj) {
	let vipInfo = getVipInfo()
	
	return http.request({
		url: '/nursing-admin/bill/billViewPageByVip',
		method: 'GET',
...
export function getBillDetail(id) {
	return http.request({
		url: '/nursing-admin/bill/billView/' + id,
		method: 'GET'
	})
}
...
export function cancelBill(id) {
	...
	return http.request({
		url: '/nursing-admin/bill/cancel?billId=' + id + '&userId=' + vipInfo.userId + '&vipId=' + vipInfo.vipId,
		method: 'PUT'
	})
}
...
export function confirmBill(id) {
	...
	return http.request({
		url: '/nursing-admin/bill/confirm?billId=' + id + '&userId=' + vipInfo.userId + '&vipId=' + vipInfo.vipId,
		method: 'PUT'
	})
}
...
//工单支付
export function billPay(obj) {
	return http.request({
		url: '/nursing-admin/oms/pay/payment',
		method: 'POST',
		data: obj
	})
}
...
export function getTrackLists(id) {
	return http.request({
		url: '/nursing-admin/billtrack/listByTaskId?taskId=' + id,
		method: 'GET'
	})
}
