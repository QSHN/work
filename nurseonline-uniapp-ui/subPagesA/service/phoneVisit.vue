<template>
	<view class="flex-column justify-between information-box">
			...
			<view class="flex-msg bottom-01 padding-20 bg-white">
				...
				<view class="bg-white padding-10 pick-box">
					<picker :range="officeList" @change="officeChange" :value="officeIndex" range-key="officeName">
						<!-- <view>{{officeList[officeIndex].officeName}}</view> -->
		...
		<view class="button-area">
			<button @tap="submit" :disabled="canSubmit">提交</button>
		</view>
	</view>
</template>
...
<script>
	...
	import { getAllOrg,getServiceList,getOrgServiceDetail, submitOrder,getOfficeName } from '@/common/api/service/service'
