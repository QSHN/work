<template>
    <f7-page no-navbar no-swipeback login-screen>
        ...
        <div style="color: #3385FF;text-align: center;">注册登录后，在设置页面有使用手册可设置使用</div>
        <f7-block style="margin-top:50px">
            <f7-button class="hawk-login-btn" :style="{background: invalidBtn ? '#D8D8D8' : '#3385FF'}"
                       @click="doLogin">登录
            </f7-button>
        </f7-block>

        <f7-block style="margin-top:80px">
            <f7-button class="hawk-login-hotline" @click="phonecall('13790990690')">客服电话：137-9099-0690</f7-button>
        </f7-block>
