<template>
    <f7-page @page:reinit="resetLoad">
        <f7-navbar title="销售订单" back-link>
            <f7-nav-right>
        ...
        <div class="p_content">
            <div class="pc_layer">
                ...
                <div class="list_item" v-for="(v, i) in list" @click="$f7router.navigate('/psiManage/salesOrder/detail', { props: { detail: v }})">
                    ...
                    <p>订购金额： {{v.allPrice}} 元</p>
                    <p>优惠金额： {{v.allPrice - v.receivable}} 元</p>
                    <p>应收金额： {{v.receivable}} 元</p>
                </div>
...
export default {
    ...
    methods: {
        ...
        searchFun () {
            this.$f7router.navigate('/psiManage/salesOrder/search', {
                props: {
                    search: (val) => {
                        this.filter = {...val}
