    ...
    <f7-page @page:reinit="resetLoad">
        ...
        <div class="p_content">
            <div class="pc_layer">
                ...
                <div class="list_item" v-for="(v, i) in list" @click="$f7router.navigate('/psiManage/carSales/order/detail', { props: { detail: v }})">
                    <div class="title">
                        {{v.name}}
...
export default {
    ...
    methods: {
        ...
        searchFun () {
            this.$f7router.navigate('/psiManage/carSales/order/search', {
                props: {
                    search: (val) => {
                        this.filter = {...val}
        ...
        async load (state, cb) {
            ...
            await axios.post('api/carSales/order/list', this.filter).then(res => {
                this.identifier++;
