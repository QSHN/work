        ...
        <div class="p_content">
            <div class="pc_layer">
                ...
                <div class="list-item clear-float textarea-item">
                    <span class="item-icon"></span>
                    <label>陈列情况</label>
                    <textarea  :value="formData.exhibit"
                               readonly>
                    </textarea>
                </div>
                ...
                <div class="list-item photo-item" style="height: 110px;">
                    <span class="item-icon"></span>
                    <label>竞品相片 ({{formData.photos.length}} / 5)</label>
