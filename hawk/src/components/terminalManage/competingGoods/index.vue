<template>
    <f7-page @page:reinit="resetLoad">
        <f7-navbar title="竞品上报" back-link></f7-navbar>

        <div class="p_content">
            <div class="pc_layer">
                <div class="list_item" v-for="(v, i) in list" @click="$f7router.navigate('/terminalManage/competingGoods/detail', { props: { detail: v }})">
                    <div class="pic">
        ...
        methods: {
                ...
                if (data.photos.length) {
                    ...
                    await getSignUrl(url, (ret) => {
                        if (ret instanceof Error) {
                            this.$set(this.imgList, data._id, '#')
                        } else {
            ...
            addFun () {
                if (this.visitData && this.visitData.visitor !== this.myUserId) {
                    ...
                    this.$f7router.navigate('/terminalManage/competingGoods/update', {
                        props: {
            ...
            async load (state, cb) {
                ...
                await axios.post('api/competingGoods/list', this.filter).then(res => {
                    this.identifier++;
