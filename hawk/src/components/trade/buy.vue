<template>
    <f7-page>
        ...
        <!--<div class="duration-list">-->
            <!--<div>-->
                <!--<span style="padding: 2px 0; display: inline-block;">定制化或买断版本</span>-->
                <!--<p style="float: right; background: #01B38B; padding: 2px 5px; color: #FFFFFF;"-->
                   <!--@click="$f7router.navigate('/software/visitingService/', { props: { isBuy: true }})">申请</p>-->
            <!--</div>-->
        <!--</div>-->
        ...
        <p style="color: red; font-size: 16px; padding: 10px 20px; line-height: 24px">安卓9.0版本以上的部分机型双开微信，有可能导致无法微信支付，如出现这种情况，请改用支付宝支付</p>
