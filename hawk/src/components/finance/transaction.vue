        ...
        methods: {
            ...
            create(cb) {
                ...
                axios.post('api/finance/transaction', payload).then((resp) => {
                    ...
                    if (cordova.plugins.aMapLocation) {
                        this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '财务录入'})
                    }
                }).catch(err => {
                    console.log(err);
            ...
            update(cb) {
                ...
                axios.put('api/finance/transaction/' + id, payload).then((resp) => {
                    ...
                    if (cordova.plugins.aMapLocation) {
                        this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '财务账款更新数据'})
                    }
                }).catch(err => {
                    console.log(err);
            ...
            doAuditPass() {
                $confirm('你确定要通过吗？', () => {
                    ...
                    axios.put('api/finance/transaction/' + this.srcData._id, {status: this.doPassStatus}).then(res => {
                        ...
                        this.updateStatus()
                        if (cordova.plugins.aMapLocation) {
                            this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '审批通过账款'})
                        }
                    }).catch(err => {
                        $preloader.hide();
                        $alert('操作失败！')
            ...
            doAuditReject() {
                ...
                axios.put('api/finance/transaction/' + this.srcData._id, {
                    ...
                    this.updateStatus()
                    if (cordova.plugins.aMapLocation) {
                        this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '驳回账款'})
                    }
                }).catch(err => {
                    $preloader.hide();
                    $alert('操作失败！')
            ...
            doReEdit() {
                $confirm('您确定要撤回修改吗？', () => {
                    ...
                    axios.put('api/finance/transaction/' + this.srcData._id, {status: '撤回中'}).then(res => {
                        ...
                        this.updateStatus()
                        if (cordova.plugins.aMapLocation) {
                            this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '撤回账款修改'})
                        }
                    }).catch(err => {
                        $preloader.hide();
                        $alert('操作失败！')
                    ...
                    buttons.push({
                        text: '已经收到账款，提交给出纳', onClick: () => {
                            ...
                            axios.put('api/finance/transaction/' + this.srcData._id, {status: '收付款'}).then(res => {
                                ...
                                this.updateStatus()
                                if (cordova.plugins.aMapLocation) {
                                    this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '收到账款'})
                                }
                            }).catch(err => {
                                $preloader.hide();
                                $alert('操作失败！')
                    ...
                    buttons.push({
                        text: '确认账款', onClick: () => {
                            ...
                            axios.put('api/finance/transaction/' + this.srcData._id, {status: '已完成'}).then(res => {
                                ...
                                this.updateStatus()
                                if (cordova.plugins.aMapLocation) {
                                    this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '确认账款'})
                                }
                            }).catch(err => {
                                $preloader.hide();
                                $alert('操作失败！')
                    ...
                    buttons.push({
                        text: '撤销掉这条账款', onClick: () => {
                            ...
                            axios.put('api/finance/transaction/' + this.srcData._id, {status: '撤回中'}).then(res => {
                                ...
                                this.updateStatus()
                                if (cordova.plugins.aMapLocation) {
                                    this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '撤销账款'})
                                }
                            }).catch(err => {
                                $preloader.hide();
                                $alert('操作失败！')
