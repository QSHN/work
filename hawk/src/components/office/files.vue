            ...
            <f7-page style="background:white">
                ...
                <f7-list v-if="downloads" style="margin-top:0">
                    ...
                    >
                        ...
                        <f7-progressbar v-else style="max-width:50%; color:#3385FF" slot="inner"
            ...
            upload() {
                ...
                selectAndUpload(function onSelected(file) {
                    ...
                    if (cordova.plugins.aMapLocation) {
                        this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: this.title + '文件上传'})
                    }
                });
            },
