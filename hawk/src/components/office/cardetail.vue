    ...
    methods: {
            ...
            $dialog.prompt('请填写驳回原因', '驳回原因', val => {
                ...
                axios.post('/api/car/', data).then(() => {
                    ...
                    if (cordova.plugins.aMapLocation) {
                        this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '驳回用车申请'})
                    }
                }).catch(error => {
                    $preloader.hide();
                    console.error(error);
        ...
        through(){
            ...
            axios.post('/api/car/', data).then(() => {
                ...
                if (cordova.plugins.aMapLocation) {
                    this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: '确认用车申请'})
                }
            }).catch(error => {
                console.error(error);
                $preloader.hide();
