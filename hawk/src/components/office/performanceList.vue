                ...
                <div class="approval-list" v-for="(item,index) in approveList" :key="index" @click="goDetail(item)">
                    ...
                    <div class="expense-right">
                        ...
                        <li class="expense-right-des">
                            <span>提交时间：{{moment(item.createdAt).format('YYYY-MM-DD HH:mm')}}</span>
                        </li>
                        <li class="expense-right-des">
                            <span>本月工作内容：{{item.lastContent}}</span>
                        </li>
                        <li class="expense-right-des">
                            <span>本月完成情况：{{item.lastSchedule}}</span>
                        </li>
                        <li class="expense-right-des">
                            <span>完成率：{{item.finishing}}</span>
                        </li>
                        <li class="expense-right-des">
                            <span>本月工作自评：{{item.selfAssessment}}</span>
                        </li>
                        <li class="expense-right-des">
                            <span>下月工作目标：{{item.content}}</span>
                        </li>
                        <li class="expense-right-des">
                            <span>下月工作计划：{{item.plan}}</span>
                        </li>
