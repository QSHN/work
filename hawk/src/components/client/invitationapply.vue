        ...
        <div>
            ...
            <div class="list-item photo-item">
                ...
                <div class="clearfix">
                    ...
                    <div class="item-selpon" @click="selectorPersonnelShow=true" v-if="formData.approver.length == 1">
                        <div class="item-image">
                            <img :src=btn_add_people width="40px" height="40px">
                        </div>
            ...
            if (!this.formData.name.length) {
                ...
                axios.put('/api/invitation/', data).then(resp=>{
                    ...
                    if (cordova.plugins.aMapLocation) {
                        this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: `申请邀约到访`})
                    }
                }).catch(err => {
