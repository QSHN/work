    ...
    <div class="preference">
        <div style="background-color: white;">
            <div class="header" :style="{'background':'url('+infoImg+')','background-size':'100% 100%'}">
                <!--<div class="pay-button" v-if="IamSuperAdmin" @click="jumpTo('/trade/info')">进入企业支付 ></div>-->
                <div class="self-info">
            ...
            <div class="item-list">
                <ul>
                    <li class="clear-float"
                        v-for="(obj,index) in checkPermission(settings.software)" :key="index"
                        :class="{emphasize: obj.isEmphasize}"
    ...
    export default {
        ...
        mounted() {
            this.settings.software = [
                ...
                //     link: "/software/message/",
                //     params: {},
                //     isEmphasize: true
                // },
                // {
                //     title: "我要兼职",
                //     icon: require("assets/images/partTime.png"),
                //     link: "/software/partTime/",
                //     isEmphasize: true
                // },
                // {
                //     title: "加盟代理",
                //     icon: require("assets/images/handshake.png"),
                //     link: "/software/visitingService/",
                //     params: {},
                //     isEmphasize: true
                // },
                // {
                //     title: "个人定制化或买断版本",
                //     icon: require("assets/images/shop_car.png"),
                //     link: "/software/visitingService/",
                //     params: {
                //         isBuy: true
                //     },
