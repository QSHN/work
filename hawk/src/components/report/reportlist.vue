        ...
        <div>
            ...
            <div class="list-item" v-for="(data,i) in reportDatas"  >
                ...
                <div class="list-footer list-container" @click="auditReport(i)">
                    ...
                    <span v-if="data.status == '已读'" style="color: #3385FF">{{data.status}}</span>
            ...
            delete(index){
                ...
                axios.delete('api/reportdata/'+report._id).then(resp => {
                    ...
                    if (cordova.plugins.aMapLocation) {
                        this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: `删除汇报`})
                    }
                });
            },
