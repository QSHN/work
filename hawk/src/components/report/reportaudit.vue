                ...
                $dialog.confirm('是否确认该汇报?','确认', function () {
                    ...
                    axios.put(path, self.reportData).then(resp => {
                        ...
                        if (cordova.plugins.aMapLocation) {
                            this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: `确认汇报`})
                        }
                    }).catch(err => {
            ...
            reject(){
                ...
                $dialog.prompt('请填写驳回原因', '驳回原因', val => {
                    ...
                    axios.put(path, self.reportData).then(resp => {
                        ...
                        if (cordova.plugins.aMapLocation) {
                            this.$store.dispatch('createMarker', {device: device, aMapLocation: cordova.plugins.aMapLocation, content: `驳回汇报`})
                        }
                    }).catch(err => {
                        self.reportData.status = status;
