    ...
    <f7-page :id="pageId">
        ...
        <vodal class="date-modal" :show="dateDialog" animation="zoom" measure="px" :width=250 :height=280 :closeButton=false>
            ...
            <div class="modal-form">
                ...
                <div class="score_bt" @click="setScore(formItem)">绩效设置</div>
            </div>
        ...
        <vodal class="date-modal" :show="ruleDialog" animation="zoom" measure="px" :width=250 :height=340 :closeButton=false>
            <div class="modal-title">绩效设置 (达标:{{editItemRule.targetValue}}{{editItemRule.unit}})</div>
...
.save_tmp span{
    display:block;text-align: center; width:100%;color:#3385FF;
}
.unit{
    text-align: right;
    width:40%;
