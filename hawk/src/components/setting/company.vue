            ...
            return {
                ...
                itemList: [
                    ...
                    // },
                    {
                        title: "考勤管理",
                        icon: "clock-o",
                        link: "/setting/company/timecards",
                        category: "日常办公",
                        name: '考勤管理',
                        props: {
                            lastPage: '公司设置'
                    ...
                    // },
                    {
                        title: "节假日设置", category: "日常办公", name: '考勤管理', icon: "calendar-times-o", link: "/setting/holiday/", props: {
                            lastPage: '公司设置'
                        }
                    },
                    {},
                    {
                        title: "客户区域", category: "客户管理", name: '客户管理', icon: "globe", link: "/setting/tree/", props: {
                            lastPage: '公司设置',
                            name: '区域',
                            src: 'regions'
                        }
                    ...
                    {
                        title: "客户等级", category: "客户管理", name: '客户管理', icon: "star-o", link: "/setting/meta/", props: {
                            lastPage: '公司设置',
                            navTitle: '客户等级',
                    ...
                    {
                        title: "客户类型", category: "客户管理", name: '客户管理', icon: "address-card", link: "/setting/meta/", props: {
                            lastPage: '公司设置',
                            navTitle: '客户类型',
                            dataType: 'clientType'
                        }
                    ...
                    {},
                    {
                        title: "仓库管理", icon: "home", link: "/selectList", props: {
                            isAdd: true,
                            which: {
                                name: '仓库',
                                type: 'warehouse'
                    ...
                    {
                        title: "车销车辆管理", icon: "car", link: "/psiManage/carSales/car"
                    },
                    {},
                    {
                        title: "商品过期通知", icon: "bullhorn", link: "/setting/commodityNote/", props: {
                            lastPage: '公司设置',
                            navTitle: '商品过期通知'
                        }
                    },
                    {
                        title: "客户欠费通知", icon: "bullhorn", link: "/setting/clientNote/", props: {
                            lastPage: '公司设置',
                            navTitle: '客户欠费通知'
                        }
                    },
                    {},
                    {
                        title: "公司内部联络单类型", icon: "envelope", link: "/setting/internalContact/", props: {
                            lastPage: '公司设置',
                            navTitle: '公司内部联络单类型'
                        }
                    },
                    {
                        title: "员工评分等级", icon: "star", link: "/setting/employeesScore/", props: {
                            lastPage: '公司设置',
                            navTitle: '员工评分等级'
                        }
                    }
