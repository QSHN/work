<template>
    <f7-page>
        ...
        <f7-block style="text-align: center">
            <div>
                <img :src="icon" alt="icon" @click="openConsole">
                <p>软件版本: {{oldVersion}}</p>
            </div>
        ...
        <f7-list>
            <f7-list-item
                title="官方网站"
            >
                <f7-link slot="after" href="http://www.xiaoniuoa.com">www.xiaoniuoa.com</f7-link>
            </f7-list-item>
            ...
            <f7-list-item
                    title="软件设置"
                    link="#"
                    @click="$f7router.navigate('/software/setting/')"
            ></f7-list-item>
        </f7-list>
...
export default {
    ...
    methods: {
        ...
        openConsole () {
            this.count++
            document.getElementById('__vconsole').hidden = this.count % 2 === 0 ? true : false
        }
    }
}
</script>
