<template>
  <div>
    ...
    <Card style="margin-top: 10px;" v-if="isExpend">
      <Form label-position="top">
        ...
        <Row type="flex" style="margin-top: 15px;">
          ...
          <span style="line-height: 30px;">包括其他应收</span>
        </Row>
    ...
    <printModal
      ref="printModal"
      :printList="tableData"
      :printType="'receivableReportDetail'"
...
import { queryAllReceivableReport } from '../../api/receivableReport'
...
export default {
  ...
  methods: {
    ...
    load () {
      ...
      queryAllReceivableReport(obj).then(res => {
