   ...
   <Card shadow style="margin: 10px 0;">
     <Row type="flex">
       ...
       <div style="display: flex; margin-left: 20px;">
         ...
         <!--<Input v-model="search.subject" style="width: 168px" readonly />-->
   ...
   <Card shadow>
     <div class="c_table">
       <div class="t_h">
         ...
         <div class="tb tb2_1">借方金额</div>
         <div class="tb tb2_1">贷方金额</div>
         <div class="tb tb2_1">余额</div>
       </div>
       ...
       <div class="t_c" v-if="tableData.balance">
         <ul>
           <li style="background: #f8f8f9">
             ...
             <div class="tb tb2_1" style="text-align: right">{{tableData.balance && formatMoney(tableData.balance.borrower || 0, '', 2)}}</div>
             <div class="tb tb2_1" style="text-align: right">{{tableData.balance && formatMoney(tableData.balance.lender || 0, '', 2)}}</div>
             <div class="tb tb2_1">
         ...
         <div v-for="(v, i) in tableData.list" :key="i">
           <ul  v-for="(v1, i1) in v.day" :key="i1">
             <li v-for="(v2, i2) in v1.child" :key="i2"
               ...
               <div class="tb tb2_1" style="text-align: right">{{formatMoney(v2.borrower || 0, '', 2)}}</div>
               <div class="tb tb2_1" style="text-align: right">{{formatMoney(v2.lender || 0, '', 2)}}</div>
               <div class="tb tb2_1">
             ...
             <li style="background: #fdf2bd">
               ...
               <div class="tb tb3"></div>
               <div class="tb tb2_1" style="text-align: right">{{formatMoney(v1.borrower || 0, '', 2)}}</div>
               <div class="tb tb2_1" style="text-align: right">{{formatMoney(v1.lender || 0, '', 2)}}</div>
               <div class="tb tb2_1">
           ...
           <ul>
             <li style="background: #fdf2bd">
               ...
               <div class="tb tb3"></div>
               <div class="tb tb2_1" style="text-align: right">{{formatMoney(v.borrower || 0, '', 2)}}</div>
               <div class="tb tb2_1" style="text-align: right">{{formatMoney(v.lender || 0, '', 2)}}</div>
               <div class="tb tb2_1">
         ...
         <ul>
           <li style="background: #d8e5cf">
             ...
             <div class="tb tb3"></div>
             <div class="tb tb2_1" style="text-align: right">{{formatMoney(total('borrower'), '', 2)}}</div>
             <div class="tb tb2_1" style="text-align: right">{{formatMoney(total('lender'), '', 2)}}</div>
             <div class="tb tb2_1">
...
export default {
  ...
  watch: {
    ...
    '$route': {
      handler () {
        if (this.$route.name !== 'accountingDetailIndex') return
        let {
          accountSetId,
          subjectCode,
          subject,
